...
contract FutarchyGovernance is Ownable {
  ...
  function createGoal(string calldata _description, uint _goalMaturity) public onlyOwner {
    address addr = address(new FutarchyGoal(_description, msg.sender, _goalMaturity));
    goals.push(addr);
