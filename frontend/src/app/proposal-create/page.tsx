...
export default function ProposalForm() {
  ...
  async function submit(formData: any) {
    const goalMetadata = { title: formData.get('title'), overview: formData.get('overview'), externalLink: formData.get('externalLink')}
      ...
      <Box maxW="600px" mx="auto" p={4} style={{marginTop: '3rem', marginBottom: '12rem'}}>
        ...
        <VStack spacing={4} align="stretch">
          ...
          <FormControl style={{marginTop:'1rem'}}>
            ...
            <Textarea name="overview" placeholder="This proposal aims to encourage people using more their bicycles and less their cars..." />
          </FormControl>
