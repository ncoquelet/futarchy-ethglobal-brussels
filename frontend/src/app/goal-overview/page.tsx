...
import { Avatar, AvatarBadge, AvatarGroup, Wrap, WrapItem, Progress, Button, ButtonGroup } from "@chakra-ui/react";
...
function GoalOverviewContent() {
  ...
  const proposalList = goal.proposals.map((proposal, index) => (
    <div className="proposal-card" key={proposal.title} style={{ marginBottom: "6rem" }}>
      ...
      <div style={{ display: "flex", marginTop: "1rem" }}>
        ...
        >
          <div onClick={() => buyYes(proposal.addr, 1)}>
            <svg xmlns="http://www.w3.org/2000/svg" height="60px" viewBox="0 -960 960 960" width="60px" fill="#1DBF1A">
        ...
        >
          <div onClick={() => buyNo(proposal.addr, 1)}>
            <svg xmlns="http://www.w3.org/2000/svg" height="60px" viewBox="0 -960 960 960" width="60px" fill="#FF6B6B">
      ...
      <div style={{ display: "flex", marginTop: "0.6rem", marginBottom: "1.2rem" }}>
        ...
        >
          <div style={{ color: "white", marginLeft: "1rem", fontWeight: "bold" }}>30%</div>
        </div>
        <div
          style={{
            width: "70%",
        ...
        >
          <div style={{ color: "white", marginRight: "1rem", fontWeight: "bold" }}>70%</div>
        </div>
      </div>
      <div></div>
      <div
    ...
    <div className="font-satoshi">
      ...
      <div style={{ marginLeft: "8rem", marginRight: "8rem", marginBottom: "2rem", marginTop: "4rem" }}>
        <div style={{ display: "flex", marginBottom: "1.5rem" }}>
          <div style={{ fontSize: "2rem", fontWeight: "bold", flex: "0 0 60%" }}>{goal.title}</div>
        </div>
